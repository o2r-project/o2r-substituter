...
describe('Simple substition of data', function () {
    describe('POST /api/v1/substition response with new ERC id', () => {
        var comp_1;
        var comp_2;
        ...
        it('should respond with HTTP 200 OK', (done) => {
            request(global.test_host + '/api/v1/substition', (err, res, body) => {
                let req = {};
    ...
    describe('POST /api/v1/compendium with one invalid compendium ID', () => {
        it('should fail the substition', (done) => {
            // TODO
